...
// battery
#define EPD_BATT_UUID 0x2A19

// temperature
#define EPD_TEMP_UUID 0x2A6E
...
extern bStatus_t EPDService_SetParameter(uint8_t param, uint16_t len,
                                         void *value);
extern bStatus_t EPDService_GetParameter(uint8_t param, uint16_t *len,
                                         void *value);
