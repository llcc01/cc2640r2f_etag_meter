...
// Unix Epoch UUID
CONST uint8 EpdEpochUUID[ATT_BT_UUID_SIZE] = { LO_UINT16(EPD_EPOCH_UUID),
...
CONST uint8 EpdBattUUID[ATT_BT_UUID_SIZE] = { LO_UINT16(EPD_BATT_UUID),
                                              HI_UINT16(EPD_BATT_UUID), };

CONST uint8 EpdTempUUID[ATT_BT_UUID_SIZE] = { LO_UINT16(EPD_TEMP_UUID),
...
CONST uint8 EpdRxTxUUID[ATT_BT_UUID_SIZE] = { LO_UINT16(EPD_RXTX_UUID),
...
// Service declaration
static CONST gattAttrType_t EpdServiceDecl =
        { ATT_BT_UUID_SIZE, EpdServiceUUID };
...
CONST gattServiceCBs_t EpdServiceCBs = { EPDService_ReadAttrCB, // Read callback function pointer
...
bStatus_t EPDService_AddService(uint8_t rspTaskId)
{
    ...
    EpdDataConfig = (gattCharCfg_t*) ICall_malloc(
                                        ...
                                        uint8_t method)
{
    ...
    if (changeParamID != 0xFF)
    {
        ...
        {
            pAppCBs->pfnChangeCb(connHandle, changeParamID, len + offset,
